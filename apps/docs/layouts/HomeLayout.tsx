...
const HomeLayout: FC<Props> = (props: Props) => {
  ...
  return (
    <>
      <Head>
        <title>{asPath === '/' ? 'Dijets Docs' : `${props.meta?.title} | Dijets Docs`}</title>
      ...
      <NextSeo
        canonical={props.meta?.canonical ?? `https://dev.dijets.io/docs${asPath}`}
        openGraph={{
          url: `https://dev.dijets.io/docs${asPath}`,
          type: 'article',
