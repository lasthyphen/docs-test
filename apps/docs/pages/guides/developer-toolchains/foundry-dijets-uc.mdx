...
- Basic understanding of the [Dijets's architecture](/guides/getting-started/platform)
...
[Dijets Network Runner](/guides/dijets-up-tool) is a tool to quickly
...
In order to deploy contracts, you need to have some test DJT in your wallet. You can get testnet
DJT from [Dijets Faucet](https://faucet.dijets.io), that transfers a small amount of test DJT tokens for
...
1. Specify the private key with test DJT to deploy the contract.
