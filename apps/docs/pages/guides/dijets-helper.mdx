...
export const meta = {
  ...
  description: 'Useful scripts to generate private keys and public addresses for Dijets Accounts',
...
To generate your deterministic Dijets (DJT) addresses, type the following commands in your terminal:
