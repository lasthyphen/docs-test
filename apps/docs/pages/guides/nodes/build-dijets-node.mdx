...
export const meta = {
  id: 'build-dijets-node',
  title: 'How to build Dijets Node',
...
Please read [this](/guides/getting-started/tutorials/create-local-network#setting-bin-in-your-path) for details. You can verify
...
Check out [Add a Validator](/guides/nodes/validator-nodes) for a step-by-step guide on how to become a Validator.
