...
out the tutorial on [Node Backup](/guides/nodes/node-backup-restore) for backup and
restore procedure.
...
- `admin` - [Admin API](/docs/guides/node-apis/admin-api) will be enabled
...
- `index` - [Index API](/docs/guides/node-apis/index-api) will be
  enabled
...
[here](/guides/nodes/node-flags-configs). Configuration may look like
this:
...
[here](/guides/nodes/node-flags-configs) to read about the chain configuration for Utility Chain.
...
node](/docs/guides/node-apis/issuing-api-calls), [stake your
dijets](/guides/nodes/staking), learn more about validators/delegators and how you can help
secure the network and [earn DJT](/guides/nodes/validator-nodes) or check your node's health by calling
[Healthcheck APIs](/docs/guides/node-apis/health-api) to get a better
...
Collection](/docs/guides/postman-api) to issue API calls directly through the postman app or in your browser.

Finally, if you haven't already, it is always good practice to [back
up](/guides/nodes/node-backup-and-restore) your files in case of a major issue or if you plan on changing your host machine.
