...
export const meta = {
  ...
  description: 'Dijets Platform Services & Dijets Security when compared with other blockchains. Dijets is by far the best performing Blockchain there is.',
}
