...
a minimal transaction fee. The fee is paid in DJT. There are no miners in Dijets so the ransaction fee is instead burned
...
- Learn how to Adjust Gas Prices during high network activity [Adjusting Gas Prices](/guides/getting-started/tutorials/dynamic-gas-fee).
- Learn how to send a transaction with Dynamic Fees using DijetsJS [DijetsJS](/guides/getting-started/tutorials/dynamic-gas-fee)
