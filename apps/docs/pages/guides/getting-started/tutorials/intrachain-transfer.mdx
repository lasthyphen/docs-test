...
1. You have some balance of Test DJT on any of the Value, Utility or Method Chain.
...
Please note that this article shows how to transfer DJT programmatically between any two
chains on Dijets.
...
In order to send DJT, you need to have some DJT. You can use a pre-funded
account on local network or get testnet DJT from the [Dijets
...
The easiest way to transfer DJT between chains is to use
[DijetsJs](https://github.com/Dijets-Inc/dijetsJs) which is a programmatic
way to access and move DJT.

DijetsJs allows you to create and sign transactions locally which is why it
is the recommended way to transfer DJT between chains. We are moving away from
...
| :----------------------- | :-------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------- |
| **_Value Chain >> Utility Chain_** | [**Value Chain: Export DJT to Utility Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/avm/buildExportTx-cchain-djtx.ts)   | [**Utility Chain : Import DJT from Value Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/evm/buildImportTx-xchain.ts)        |
| **_Value Chain >> Method Chain_** | [**Value Chain : Export DJT to Method Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/avm/buildExportTx-PChain.ts)        | [**Method Chain : Import DJT from Value Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/platformvm/buildImportTx-XChain.ts) |
| **_Method Chain >> Value Chain_** | [**Method Chain : Export DJT to Value Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/platformvm/buildExportTx-XChain.ts) | [**Value Chain : Import DJT from Method Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/avm/buildImportTx-PChain.ts)        |
| **_Method Chain >> Utility Chain_** | [**Method Chain : Export DJT to Utility Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/platformvm/buildExportTx-CChain.ts) | [**Utility Chain : Import DJT from Method Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/evm/buildImportTx-PChain.ts)        |
| **_Utility Chain >> Value Chain_** | [**Utility Chain : Export DJT to Value Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/evm/buildExportTx-xchain-djtx.ts)   | [**Value Chain : Import DJT from Utility Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/avm/buildImportTx-cchain.ts)        |
| **_Utility Chain >> Method Chain_** | [**Utility Chain : Export DJT to Method Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/evm/buildExportTx-pchain.ts)        | [**Method Chain : Import DJT from Utility Chain**](https://github.com/Dijets-Inc/dijetsJs/blob/master/examples/platformvm/buildImportTx-CChain.ts) |
...
folder to view the DijetsJS Value Chain examples. To export DJT from the Value Chain
...
Below sets a new value of 0.01 DJT (`10000000` Gwei). Value is set in Gwei
format where `1,000,000,000` Gwei = 1 DJT
...
folder to view the DijetsJS Utility Chain examples. To import DJT to the Utility Chain
...
Select the
[**`examples/evm`**](https://github.com/Dijets-Inc/dijetsJs/tree/master/examples/evm)
folder to view the DijetsJS Utility Chain examples. To export DJT from the Value Chain
to the Utility Chain, select
...
You can change the amount of DJT to send by editing the _BN_ variable:
`djtxAmount`. The sample code assigns this as `1e7` or `10000000` (0.01 DJT)
...
- Network setting should be to a Mainnet node, either [a local node on
  Mainnet](..//docs/guides/nodes/node-flags-configs#network-id) or
  [Dijets Mainnet API
