...
export const meta = {
  id: 'value-chain-api',
  title: 'Keystore API',
  description: 'Learn how to make calls to the keystore API exposed by dijets node.',
}
...
[DijetsJS](/guides/dijetsjs). That way control keys for your funds won't be stored on
...
- [Transfer DJT Tokens Between Chains](docs/guides/getting-started/tutorials/intrachain-transfer)
- [Add a Node to the Validator Set](docs/guides/nodes/validator-nodes)
...
[`keystore.importUser`](keystore-api.md#keystoreimportuser). The user’s password remains encrypted.
