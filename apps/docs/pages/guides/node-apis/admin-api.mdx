...
export const meta = {
  id: 'value-chain-api',
  title: 'Admin API',
  description: 'How to make calls to the admin api endpoint exposed by dijets node.',
}
...
enabled, use [config flag `--api-admin-enabled=true`](../../..//docs/guides/nodes/node-flags-configs#--api-admin-enabled-boolean).
