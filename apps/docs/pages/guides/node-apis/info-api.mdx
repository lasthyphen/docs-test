...
export const meta = {
  id: 'value-chain-api',
  title: 'Info API',
  description: 'Learn how to make calls to dijets node to access its basic information.',
}
...
Given a blockchain’s alias, get its ID. (See [`admin.aliasChain`](admin-api#adminaliaschain).)
