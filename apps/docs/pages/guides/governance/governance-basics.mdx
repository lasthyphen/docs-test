...
Because Dijets and networks like Dijets are virtually unstoppable, by extension that makes all the payments conducted on it with its native currency (DJT) also unstoppable. An autonomous organisation like such is free to contract and trade permissionlessly with any person or organization also on that network anywhere in the world without limitations or restrictions.
