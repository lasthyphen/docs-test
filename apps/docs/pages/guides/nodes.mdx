...
Not only does running a validator node enable you to receive rewards in DJT,
but also enables you to validate other Subnetworks or [ECCs](/docs/guides/ecc-overview) in the ecosystem as
...
DJT (which can be reduced over time as price increases). Alternatively,
...
that don’t meet the minimum staking requirements can always delegate their DJT to
