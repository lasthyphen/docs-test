...
DJT or any other asset as the gas or transaction fee for the network. Will it be a permissioned or open to pre-qualified validators only network.
...
you use and optionally, how you distribute it. You may use DJT, an existing Utility Chain token, or a
