...
Now that you have learnt how to deploy your ECC using ECCVM Cli tool.
You can connect Metamask to an ECC as shown below.
...
![Import MetaMask Account](/docs/img/metamask-import.png)

Import the well-known private key `0x56289e99c94b6912bfc12adc093c9b51124f0dc54ac7a766b2bc5ccf558d8027`.

![Import Account Private Key](/docs/img/metamask-import2.png)

Its good practise to change your account name at this time to avoid any confusion. Switch to the new account and click the
three dot menu in the top right corner. Select `Account details`. Click the edit icon next to the
account's name. And rename the account `Test Account ECC` or something that you can easily differentiate with your other wallet names.

![Rename Account](/docs/img/metamask-import3.png)
...
![MetaMask Add Network](/docs/img/metamask-import5.png)

At the bottom of the next page, select `Add a network manually`. Enter your ECC's details,
found in the output of your `dijets ecc deploy` [command](#deploying-ecc-locally), into
the form and click `Save`.

![Add ECC Network Details](/docs/img/metamask-import7.png)

If all worked as expected, your balance should read 100,000 tokens. Your ECC is ready for
action.

![ECC in MetaMask](/docs/img/metamask-import6.png)

## Next Steps

Congrats! You just deployed your first ECC. Where you take your ECC, which rule-sets you integrate into it further and which smart contracts you opt to
