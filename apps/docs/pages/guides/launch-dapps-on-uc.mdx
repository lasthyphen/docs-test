...
[Click here](/guides/developer-toolchains/using-hardhat-with-the-dijets-utility-chain.md) to learn how to use HardHat with Dijets.
...
See [this](/guides/developer-toolchains/verify-smart-contracts-with-sourcify)
